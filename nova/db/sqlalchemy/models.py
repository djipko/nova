...
class ComputeNode(BASE, NovaBase):
    ...
    # json-encoded dict that contains CPU pinning data as generated by
    # nova.virt.hardware.VirtHostCPUPinning.to_json()
    cpu_pinning = Column(Text)
...
class InstanceExtra(BASE, NovaBase):
    ...
    cpu_pinning = orm.deferred(Column(Text))
    instance = orm.relationship(Instance,
