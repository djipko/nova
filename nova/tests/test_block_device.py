...
class TestBlockDeviceDict(test.TestCase):
    ...
    def test_from_legacy_mapping(self):
        ...
        new_no_img = block_device.from_legacy_mapping(
            self.legacy_mapping, None)
        ...
        image_bdms[0]['boot_index'] = 0
        boot_bdms[0]['source_type'] = 'image'
        ...
        self.assertEquals(len(boot_bdms), 1)
        boot_bdms[0]['source_type'] = 'volume'
        boot_bdms[0]['boot_index'] = 0
