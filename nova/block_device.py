...
bdm_new_non_api_fields = set(['volume_id', 'snapshot_id', 'image_id'])
...
class BlockDeviceDict(dict):
    ...
    def from_api(cls, api_dict):
        """Transfor the API format of data to the format internaly used
        by Nova. Only validate if the source_type field makes sense.
        """
